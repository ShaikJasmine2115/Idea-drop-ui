...
export const createIdea = async (newIdea: {title: string, summary: string, body: string, tags?: string[]}): Promise<Idea> => {
...
export const updateIdea = async (ideaId: string, updatedData: {
    title:string, description: string, summary: string, tags: string[]}): Promise<Idea> =>{
